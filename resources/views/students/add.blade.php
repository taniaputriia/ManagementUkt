        ...
        @role('Mahasiswa')
            ...
            <div class="card-body">
                <form action="{{ route('student.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="address">Alamat</label>
                        <textarea name="address" name="address" class="form-control" id="address" value="{{ old('address') }}">
                    </textarea>
                    </div>
                    <div class="form-group">
                        <label for="study_program">Program Studi</label>
                        <select class="form-select select_study_program" name="study_program" id="study_program">
                            <option value="" selected>Pilih Salah Satu</option>
                            @foreach (App\Models\Student::STUDY_PROGRAM_CHOICE as $key => $value)
                                <option value="{{ $key }}">{{ $value }}</option>
                            @endforeach
                    ...
                    <div class="form-group">
                        <label for="major">Jurusan</label>
                        <select class="form-select select_major" name="major" id="major">
                            <option value="" selected>Pilih Salah Satu</option>
                            @foreach (App\Models\Student::MAJOR_CHOICE as $key => $value)
                                <option value="{{ $key }}">{{ $value }}</option>
                            @endforeach
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="semester" class="form-control" id="semester"
                            value="{{ old('semester') }}" placeholder="masukkan semester">
                    </div>

                    <div class="form-group">
                        <label for="academic_year">Tahun Akademik</label>
                        <input type="text" name="academic_year" class="form-control" id="academic_year"
                            value="{{ old('academic_year') }}" placeholder="masukkan tahun akademik anda">
                    </div>
                    <div class="form-group">
                        <label for="tuition_fee">Uang Kuliah Tunggal</label>
                        <input type="currency" name="tuition_fee" class="form-control" id="tuition_fee"
                    ...
                    <div class="form-group">
                        <label for="foto">Cicilan I</label>
                        <input type="file" name="photo" class="form-control" id="photo"
                            value="{{ old('photo') }}" placeholder="masukkan foto">
                    </div>
                    <hr>
                    <a href="{{ route('student.index') }}" class="btn btn-warning">Kembali</a>
                    <button type="submit" class="btn btn-primary mr-2">Simpan</button>
